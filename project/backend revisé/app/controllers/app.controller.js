    ...
    User.update(req.body, {
        ...
        .then((num) => {
            if (num == 1) {
                ...
                res.send({
                    message: `Cannot update User with id=${id}. Maybe User was not found or req.body is empty! Req body : ${req.params}`
                });
            }
        })
        .catch((err) => {
...
exports.createCatMenu = (req, res) => {
    ...
    CatMenu.create(catMenu)
        ...
        .catch((err) => {
            res.status(500).send({
                message: err.message || 'Some error occurred while creating the categoryMenu.'
            });
        });
};
...
exports.findAllCatMenu = (req, res) => {
    ...
    CatMenu.findAll({ where: condition })
        ...
        .catch((err) => {
            res.status(500).send({
                message: err.message || 'Some error occurred while retrieving categoryMenu.'
            });
        });
};
...
exports.deleteAllCatMenu = (req, res) => {
    CatMenu.destroy({
        ...
        .catch((err) => {
            res.status(500).send({
                message: err.message || 'Some error occurred while removing all categoryMenu.'
            });
        });
};
...
exports.findAllCmd = (req, res) => {
    ...
    Cmd.findAll({ where: condition })
        ...
        .catch((err) => {
            res.status(500).send({
                message: err.message || 'Some error occurred while retrieving command.'
            });
        });
};
...
exports.deleteAllCmd = (req, res) => {
    Cmd.destroy({
        ...
        .catch((err) => {
            res.status(500).send({
                message: err.message || 'Some error occurred while removing all command.'
            });
        });
};
...
exports.deleteAllTable = (req, res) => {
    Table.destroy({
        ...
        .catch((err) => {
            res.status(500).send({
                message: err.message || 'Some error occurred while removing all table.'
            });
        });
};
...
exports.deleteAllRestaurant = (req, res) => {
    Restaurant.destroy({
        ...
        .catch((err) => {
            res.status(500).send({
                message: err.message || 'Some error occurred while removing all restaurant.'
            });
        });
};
